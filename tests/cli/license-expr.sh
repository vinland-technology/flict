...
compare_exec     "$FLICT_CMD MIT and MIT and BSD-3-Clause" "BSD-3-Clause AND MIT" 0 "MIT and MIT and BSD-3-Clause"

compare_exec     "$FLICT_CMD BSD"                          "BSD-3-Clause" 0 "Expand BSD to BSD-3-Clause"
compare_exec     "$FLICT_CMD MIT and MIT and BSD"          "BSD-3-Clause AND MIT" 0 "MIT and .. BSD"
